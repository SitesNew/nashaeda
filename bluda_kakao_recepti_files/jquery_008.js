...
WBBLANG['ru']= CURLANG = {
	...
	modal_video_text: "Р’РІРµРґРёС‚Рµ URL РІРёРґРµРѕ РЅР° YouTube",
...
//			direction:			"ltr",
			...
			allButtons: {
				...
				code : {
					...
					onlyClearText: true,
					transform : {
						'<div class="codewrap"><div class="codetop" contenteditable="false">РљРѕРґ:</div><div class="codemain">{SELTEXT}</div></div>':"[code]{SELTEXT}[/code]"
					}
				},
				offtop : {
	...
	$.wysibb.prototype = {
		...
		build: function() {
			...
			this.$editor.append('<span class="powered">Powered by <a href="http://www.wysibb.com" target="_self ">WysiBB<a/></span>');
