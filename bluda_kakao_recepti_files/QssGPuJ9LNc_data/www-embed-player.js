...
b["all_"+e]=f.join()}delete a[d]}e=!!b.ap;if(f=v("ytglobal.timingReportbuilder_")){if(f=f(a,b,void 0))Wg(f,e),Xg(),Yg(),Zg(!1,void 0),Q("TIMING_ACTION")&&P("PREVIOUS_ACTION",Q("TIMING_ACTION")),P("TIMING_ACTION","")}else{var g=Q("CSI_SERVICE_NAME","youtube");f={v:2,s:g,action:Q("TIMING_ACTION",void 0)};var h=b.srt;void 0!==a.srt&&delete b.srt;if(b.strongjse){var l=window.location.protocol+v("ytplayer.config.assets.js");(l=X.getEntriesByName?X.getEntriesByName(l)[0]:null)?b.strongjse=Math.round(b.strongjse-l.responseEnd):
delete b.strongjse}a.aft=Sg();$g()&&"youtube"==g&&(Ug(),g=a.vc,l=a.pbs,delete a.aft,b.aft=Math.round(l-g));for(var m in b)"_"!=m.charAt(0)&&(f[m]=b[m]);a.ps=O();b={};m=[];for(d in a)"_"!=d.charAt(0)&&(g=Math.round(a[d]-c),b[d]=g,m.push(d+"."+g));f.rt=m.join(",");(a=v("ytdebug.logTiming"))&&a(f,b);Wg(f,e,void 0);zg(Fg,new Dg(b.aft+(h||0),void 0))}}}
